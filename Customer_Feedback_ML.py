...
rfr=RandomForestRegressor(n_estimators=10, criterion="squared_error")
# Veriyi okuma
...
plt.title('Test Seti - Gerçek vs Tahmin Edilen RFR')
plt.xlabel('Gerçek Y')
...
print(rfr.predict(np.array([30,1,0,0,0,0,1,0,83600,5,8,7,0,1,0,0,0,1]).reshape(1, -1)))
print(y_test[:5])